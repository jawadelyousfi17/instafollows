...
import { getInstagramProfile, FormattedProfile } from "./actions";
          ...
          {!profile && !boostComplete && (
            ...
            <>
              ...
              <div className="w-full max-w-[90%] md:max-w-[580px] relative group">
                ...
                {error && (
                  <div className="absolute top-full mt-4 w-full text-center p-3 rounded-xl bg-red-500/10 border border-red-500/20 text-red-500 text-sm font-bold animate-fade-in-up">
                    ⚠️ {error}
                  </div>
                )}
              </div>
            ...
            <div className="w-full max-w-2xl animate-fade-in-up bg-white dark:bg-[#183422] border border-slate-200 dark:border-[#22492f] rounded-[2rem] p-12 text-center shadow-2xl relative overflow-hidden">
              <div className="flex flex-col items-center justify-center gap-6 z-10 relative">
                ...
                <button
                  ...
                  className="mt-4 w-full py-4 rounded-xl border-2 border-slate-200 dark:border-[#22492f] hover:bg-slate-50 dark:hover:bg-[#102216] text-slate-900 dark:text-white font-bold transition-colors"
                >
